...
//                    $('#clear_img').show();
        ...
        $(document).ready(function() {
            ...
            $("#ecardform").submit(function(e)
            {
                ...
                if(mode_submit=="desc"){
                    $('#fbuid').val('');
//                    //$('#image-cropper').cropit('previewSize', { width: 400, height: 400 });
//                    var zoom =  $('#image-cropper').cropit('exportZoom',2); //--- เซ็ตให้รูปที่ส่งค่าไปขนาดเท่ารูปจริง (แก้ปัญหารูปที่ส่งไปเล็กแล้วไป resize ให้ใหญ่แล้วรูปแตก)
//                    var imageData = $('#image-cropper').cropit('export', {
//                        type: 'image/jpeg',
//                        quality: 1
////                        originalSize: true
...
//                    $('.hidden-image-data').val(imageData);
                ...
                console.log(imageData);
                $('.hidden-image-data').val(imageData);
                console.log($('#image-cropper').cropit());
...
//            $('#image-cropper').cropit('initialZoom', 'min');
