...
<head>
    ...
    <link rel="stylesheet" href="{{url('memoprint/fonts/arabica2/stylesheet.css')}}">
    ...
    <link rel="stylesheet" href="{{url('memoprint/fonts/quark/stylesheet.css')}}">
    <link rel="stylesheet" href="{{url('memoprint/css/ecard.css')}}">
    <link rel="stylesheet" href="{{url('scripts/jscrollpane/jquery.jscrollpane.css')}}" >

    <script src="{{url('scripts/jquery-1.11.1.min.js')}}"></script>
    <script src="{{url('scripts/jscrollpane/jquery.mousewheel.js')}} "></script>
    <script src="{{url('scripts/jscrollpane/jquery.jscrollpane.min.js')}} "></script>
...
<div>
    ...
    <div class="main-wrapper" id="main-wrapper"  style="width:100%;height:100%; position:absolute;background: #1a1a1a;z-index:20;">
        <img src="{{url('images/ecard_main/loading.gif')}}" class="loading">
    </div>
...
//            });
    ...
    <div id="page-content" ng-controller="ecard-gallery">
        ...
        <div class="container-fluid col-md-12 col-centered">
            ...
            <section id="play-page"  style="overflow-x: hidden; display: none;background:url('{{url('images/ecard_main/bg_upload.png')}}');"  >
                            ...
                            <div class="col-md-8 img-crop-layer" >
                                ...
                                <div id="gen-image">
                                    <div class="r" style="margin-top:-615px; margin-left:45px;z-index:2;pointer-events:none;">
                                        <img src="{{url('images/ecard/201511_frame1.png')}}" id="frame_ecard" >
                                    </div>
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="a play_loy_txt" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-600px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-605px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-578px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-578px;" }}    @endif  }}"></div>--}}
                                    {{--<div class="a play_text_name" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-245px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-250px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-225px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-225px;" }} @endif  }}"></div>--}}
                                    ...
                                    {{--<div id="frame_ecard_star" class="a play_frame_2_star" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-575px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-580px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-555px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-555px;" }}  @endif  }}"></div>--}}
                                    {{--<div class="a" style=" margin-top:-539px;margin-left:117px; background: url('{{url('images/ecard/play_frame_border.png')}} ') no-repeat ;z-index: 3; width:353px;height:351px; pointer-events:none ;"> </div>--}}

                                    {{--<div class="a play_frame_border_top" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-559px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-566px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-539px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-539px;" }} @endif  }}"></div>--}}
                                    {{--<div class="a play_frame_border_bottom" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-214px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-221px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-194px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-194px;" }} @endif  }}"></div>--}}
                                    {{--<div class="a play_frame_border_left" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-563px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-570px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-540px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-540px;" }} @endif  }}"></div>--}}
                                    {{--<div class="a play_frame_border_right" style="@if(Ecad::chkBrowser("Edge")==1){{ "margin-top:-561px;"  }}@elseif(Ecad::chkBrowser("Firefox")==1) {{ "margin-top:-568px;" }}  @elseif(Ecad::chkBrowser("Chrome")==1) {{ "margin-top:-541px;" }} @elseif(Ecad::chkBrowser("MSIE")==1) {{ "margin-top:-541px;" }} @endif  }}"></div>--}}
            ...
            <section id="page-gallery"  style="margin-bottom:100px; background: url('{{url('images/ecard_main/bg_gallery.png')}}')  ; " >
                <div class="main">
                    ...
                    {{--<div class="col-md-12" align="center" style="margin-top:50px;">--}}
                        {{--<div class="col-xs-12 pd mg col-centered pagination" style="width:270px;line-height: 35px;">--}}
                            {{--<button type="button" class="r fl btn-ecard btn-e-green" style="padding: 0px 10px;" ng-click="getPosts(currentPage-1)" ><i class="glyphicon glyphicon-arrow-left btn-pagination"  ></i></button>--}}
                            {{--<div class="r col-centered" style="margin-top:0px;">--}}
                                {{--<input type="text" id="gallery_image_page" name="gallery_image_page"  ng-model="gallery_image_page" ng-change="getPosts(gallery_image_page)" class="input_pagination" style="width:80px;">--}}
                                {{--<span class="a" style="margin-top:7px; margin-left: -40px;" >OF @{{ totalPages }}</span>--}}
                            {{--</div>--}}

                            {{--<button type="button" class="r fl btn-ecard btn-e-green pull-right" style="padding: 0px 10px;" ng-click="getPosts(currentPage+1)" ><i class="glyphicon glyphicon-arrow-right btn-pagination" ></i></button>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                </div>
